...
#Include "nowUnix.ahk"
#Include "..\custom\websocket_relay.ahk"
...
priorityList:=[], defaultPriorityList:=["RelayCheck", "Night", "Mondo", "Planter", "Bugrun", "Collect", "QuestRotate", "Boost", "GoGather"]
...
; add tabs
TabArr := ["Gather","Collect/Kill","Boost","Quests","Planters","Status","Settings","Misc","Relay Main", "Relay Client", "Credits"], (BuffDetectReset = 1) && TabArr.Push("Advanced")
